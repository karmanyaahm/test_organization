...
# def getfileslist(eventlistfile, dbHelper=defaultDB):
#     if dbHelper == None:
#         dbHelper = DBHelper()
#     dbHelper.reload(eventlistfile=eventlistfile)
#     return dbHelper.getfileslist(eventlistfile)


# def get_blocked(blocklistfile, dbHelper=defaultDB):
#     if dbHelper == None:
#         dbHelper = DBHelper()
#     dbHelper.reload(blocklistfile=blocklistfile)
#     return dbHelper.get_blocked(blocklistfile)
