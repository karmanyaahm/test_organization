fileslist = [(["score", "result", "scoring", "rank", "scores"], "score_report", ["other_idk", "score"],)]
...
fileslist += [
    ...
    (["mission possible", "possible"], "mission_possible", ["technology", "rube_goldberg"]),
    ...
    (["exper", "expd", "exdes", "exp d", "xpd"], "experimental_design", ["inquiry", "experimental_design"],),
    ...
    (["rocks_and_mineral", "mineral", "rocks"], "rocks_and_minerals", ["earth_science", "rocks"],),
    ...
    (["it_s about time", "about time"], "its_about_time",['inquiry','timekeeping']),
...
fileslist += [
    # chem
    (["chem_lab", "chem lab", "chemlab", "chemistry lab"], "chemistry_lab", ["chemistry", "chemistry"],),
    (["crime"], "crime_busters", ["chemistry", "forensics"]),
    # bio
    (["anat", "a and p", "anatom", "a_p"], "anatomy_and_physiology", ["biology", "human"],),
    (["neursocience", "neuorscience"], "neuroscience",['biology','human']),
    (["bio-process"], "bioprocess",['biology','bioprocess_idk_where_this_should_go']),
...
for n, i in enumerate(fileslist):
    i = list(i)
    i[0] = list(set(list(i[0] + [i[1]] + [i[1].replace("_", " "), i[1].replace("_", ""), i[1].replace(" ", "")])))
    fileslist[n] = i
